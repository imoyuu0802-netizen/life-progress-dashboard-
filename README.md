...
- 保有銘柄ベースの想定リターンは、保守・標準・強気の3つの前提から選択できます
- 標準前提ではS&P500系を8〜8.5%、全世界株式を7%目安として扱います
- 保有銘柄ベースの想定リターンは、株価・基準価額成長の概算です。配当・分配金は年間配当として別枠でFIRE計算に入れます
- 高配当ETFや個別株は配当を年間配当で別計上するため、想定リターン側は値上がり分を中心に低めに置いています
